...
class TestDBStorage(unittest.TestCase):
    ...
    def test_new(self):
        ...
        retrieved_state = session.query(State).filter_by(id=new_state.id)\
            .first()
    ...
    def test_save(self):
        ...
        retrieved_state = session.quuery(State).filter_by(id=new_state.id)\
            .first()
    ...
    def test_count(self):
        """Test that count the number of objects based of a given class"""
        storage = models.storage
        storage.reload()
        state_data = {"name": "Lagos"}
        state_instance = State(**state_data)
        ...
        self.assertEqual(state_ocurrence, len(storage.all(State)))
